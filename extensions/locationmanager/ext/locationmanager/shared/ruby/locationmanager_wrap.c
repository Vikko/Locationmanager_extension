...
#define SWIG_init    Init_Locationmanager
#define SWIG_name    "Locationmanager"

static VALUE mLocationmanager;
...
SWIGINTERN VALUE
_wrap_get_heading(int argc, VALUE *argv, VALUE self) {
  ...
  get_heading(arg1,arg2,arg3,arg4);
  vresult = rb_ary_new();
...
extern "C"
#endif
SWIGEXPORT void Init_Locationmanager(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mLocationmanager = rb_define_module("Locationmanager");
  ...
  rb_define_module_function(mLocationmanager, "init", _wrap_init, -1);
  rb_define_module_function(mLocationmanager, "get_heading", _wrap_get_heading, -1);
}
