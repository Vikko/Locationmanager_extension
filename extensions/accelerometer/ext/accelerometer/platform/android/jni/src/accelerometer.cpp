...
extern "C" VALUE accelerometer_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/accelerometer/Accelerometer");
...
extern "C" int accelerometer_calc_summ(int x, int y) {
	return (x+y);
}
